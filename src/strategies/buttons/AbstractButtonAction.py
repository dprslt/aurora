...
class AbstractButtonAction(object):
    ...
    '''
    def register(self, bcm_port, pull_up_down, event=GPIO.FALLING, bouncetime=1000):
        ...
        GPIO.add_event_detect(bcm_port, edge=event, callback=self.action, bouncetime=bouncetime)
